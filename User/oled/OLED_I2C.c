...
void I2C_Configuration(void)
{
  ...
  I2C_InitStructure.I2C_OwnAddress1 =OLED_ADDRESS; //设备的I2C地址
...
void OLED_Init(void)
{
	...
	WriteCmd(0xa1); //--set segment re-map 0 to 127 镜像显示
	...
	WriteCmd(0x8d); //--set DC-DC enable 电荷泵
	WriteCmd(0x14); //
...
{ 
	WriteCmd(0xb0+y);  //地址b0
	WriteCmd(((x&0xf0)>>4)|0x10);   //高位起始地址10
	WriteCmd((x&0x0f)|0x00);         // 低位起始地址01
}
